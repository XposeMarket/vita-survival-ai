...
SearchEngine::SearchEngine() : database(nullptr), zimReader(nullptr), onlineSearch(nullptr) {
}

SearchEngine::~SearchEngine() {
}

void SearchEngine::Initialize(Database* db, ZIMReader* zim, OnlineSearch* online) {
    database = db;
    zimReader = zim;
    onlineSearch = online;
}
